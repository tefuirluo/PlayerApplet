...
__DEFINE__(1677036537020, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1677036537021,"./event-store":1677036537022}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1677036537021, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1677036537022, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1677036537021,"./utils":1677036537023}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1677036537023, function(require, module, exports) {
...
return __REQUIRE__(1677036537020);
})()
